(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".about-program__body")) new swiper_core_Swiper(".about-program__body", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".experts__body")) {
            ...
            resizableSwiper("(max-width: 991.98px)", ".experts__body", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".follow__body")) new swiper_core_Swiper(".follow__body", {
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            spaceBetween: 10,
    ...
    function documentHovers(e) {
        const targetElement = e.target;
        if (targetElement.closest("[data-hover]")) {
            console.log("da");
            const activeBlock = document.querySelector("._overlay-open");
            activeBlock ? activeBlock.classList.remove("_overlay-open") : null;
            const numMenu = targetElement.dataset.hover ? targetElement.dataset.hover : null, subMenu = document.querySelector(`[data-overlay="${numMenu}"]`);
            if (subMenu) subMenu.classList.toggle("_overlay-open"); else console.log("Нет такого меню!");
        }
        if (!targetElement.closest("[data-hover]")) {
            document.querySelector("._overlay-open") ? document.querySelector("._overlay-open").classList.remove("_overlay-open") : null;
            document.querySelector(".about-program-item__back").classList.add("_overlay-open");
        }
    }
